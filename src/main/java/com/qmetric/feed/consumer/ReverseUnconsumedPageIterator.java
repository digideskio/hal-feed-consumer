...
class ReverseUnconsumedPageIterator implements Iterator<List<EntryId>>
{
    private static final Logger log = LoggerFactory.getLogger(ReverseUnconsumedPageIterator.class);

    private static final String NEXT_LINK_RELATION = "previous";
    ...
    private Optional<EntryId> latestEntryConsumed;

    ReverseUnconsumedPageIterator(final HalReader halReader, final FeedEndpoint endpoint, FeedTracker feedTracker, FeedEndpointFactory feedEndpointFactory, Optional<EarliestEntryLimit> earliestEntryLimit)
    {
    ...
    public Optional<EntryId> getLatestEntryConsumed() {
        return latestEntryConsumed;
    }
