...
public class FeedConsumerScheduler
{
    ...
    private final FeedConsumer_ consumer;

    private final Interval interval;

    private final ScheduledExecutorService scheduledExecutorService;

    public FeedConsumerScheduler(final FeedConsumer_ consumer, final Interval interval)
    {
        this(consumer, interval, newSingleThreadScheduledExecutor());
    }

    FeedConsumerScheduler(final FeedConsumer_ consumer, final Interval interval, final ScheduledExecutorService scheduledExecutorService)
    {
